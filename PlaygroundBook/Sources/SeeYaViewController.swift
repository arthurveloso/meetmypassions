//
//  SeeYaViewController.swift
//  Book_Sources
//
//  Created by Arthur Melo on 24/03/19.
//

import UIKit

class SeeYaViewController: UIViewController {

    @IBOutlet weak var border: UIImageView!
    @IBOutlet weak var midfield: UIImageView!
    @IBOutlet weak var seeYa: UILabel!
    ...
    override func viewDidLoad() {
        ...
        seeYa.frame = CGRect(x: self.view.frame.width/4 - 60, y: self.view.frame.height/2 - 45, width: 120, height: 70)
